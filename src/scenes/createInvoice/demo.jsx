...
const Alert = forwardRef(function Alert(props, ref) {
    return <MuiAlert elevation={6} ref={ref} variant="filled" {...props} sx={{height : '50px'}}/>;
  });
    ...
    return (
        <Box m="20px" >
...

            {
                patientDataState
                    ...
                    <>
                        ...
                        variant="contained" onClick={() => resetForm()} sx={{
                            backgroundColor: "#878970", color:"#3b3c31",
                        ...
                        <Button onClick={() => window.print()} sx={{
                            '&:hover': { color: colors.oliveAccent[100] }, 
                            color: "#3b3c31", backgroundColor: "#878970",
                            '@media print': { display: 'none' }, fontWeight: "bold", ml: '10px',
                        }} variant="contained" width='150px' >
                            Print
                        </Button>
                    </>
                    :
                    <Box sx={{ '@media print': { display: 'none' }, display:'flex', flexWrap:'wrap'}}>
                        ...
                        >
                            ...
                            <Box sx={{ gridColumn: "span 1", '@media print': { display: 'none' } }}>
                                <Button type='button' variant='contained' 
                                    sx={{  color: "#3b3c31", fontWeight: "bold", '&:hover': { color: colors.oliveAccent[100] }, 
                                        backgroundColor: "#878970", display : editButton ? 'block' :'none'}}> Edit </Button>
                            </Box>
                            ...
                            >
                                ...
                                <Autocomplete
                                    ...
                                    sx={{
                                        ...
                                        , width: 300, '@media print': { display: 'none', height: 0, m: 0}, marginTop:'20px'
                                    }}
            ...
            <Box sx={{ flexGrow: 1, p: 0 }}>
                <TableContainer sx={tableRowData.length < 1 ?  {display: 'none'} : {display: 'block'}}>
                    <Table>
                        <TableHead >
                            <TableRow>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>Item No.</TableCell>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>Billing Item</TableCell>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>Quantity</TableCell>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>Unit Price</TableCell>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>RE %</TableCell>
                                <TableCell sx={{ p: 1, fontWeight: 'bold', border: '1px solid gray' }} align='center'>Net Amount</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {
                                tableRowData.map((service, index) => {
                                    return (
                                        <TableRow key={service.serviceId}>
                                            ...
                                            <TableCell sx={{ p: 1, border: '1px solid gray',  }} align='center'>{service.billingItem}</TableCell>
                                            <TableCell sx={{ p: 1, border: '1px solid gray',  }} align='center'>{service.quantity}</TableCell>
                                            <TableCell sx={{ p: 1, border: '1px solid gray',  }} align='center'>{service.unitPrice}</TableCell>
                                            <TableCell sx={{ p: 1, border: '1px solid gray',  }} align='center'>{service.re}</TableCell>
                                            <TableCell sx={{ p: 1, border: '1px solid gray',  }} align='center'>{service.netAmount}</TableCell>
                                        </TableRow>
                                    )
                                })
                            }
                            <TableRow>
                                ...
                                <TableCell sx={{ p: 1, border: '1px solid gray', }} align='center'>Total</TableCell>
                                <TableCell sx={{ p: 1, border: '1px solid gray', }} align='center'>{total}</TableCell>
                            </TableRow>
                            <TableRow></TableRow>
                            <TableRow>
                                {/* <TableCell colSpan={3} sx={{p : 1, border: 'none'}}></TableCell> */}
                                <TableCell colSpan={3} rowSpan={3} sx={{ p: 1, border: 'none', }}>Prepared by - <span style={{ fontWeight: '700' }}>{auth.name}</span> </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </TableContainer>
                    ...
                    >
                        ...
                        <Box>
                            <Typography
                                ...
                                fontWeight="bold"
                                sx={{ m: "0",color: colors.oliveAccent[100] }}
                            >
                                Patient Information
                            </Typography>
